        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a href="" class="nav-link nav-word"><b>Обо мне</b></a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link nav-word"><b>Услуги</b></a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link nav-word"><b>Отзывы</b></a>
                    </li>
                    <li class="nav-item">
                        <a href="" class="nav-link nav-word"><b>Контакты</b></a>
                    </li>
                </ul>
                <a href="" class="navbar-text phone nav-word"><i class="fa fa-phone" aria-hidden="true"></i><b>+79889686699</b></a>
            </div>
        </div>
    </nav>
</header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img src="/images/19.jpg" class="d-block w-100" alt="...">
...
<div class="container-fluid second">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm">
                <p class="text-about"><b>Меня зовут Екатерина Тарасова. Я работаю косметологом уже 5 лет. Я
...
<footer id="contacts">
    <div class="container">
        <div class="row footer-row">
            ...
            <div class="col">
                <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A0a950030e2a880e59989bd541754141709b985743a03854f6c596dac77c2c9a8&amp;width=511&amp;height=300&amp;lang=ru_RU&amp;scroll=true"></script>
            </div>
        </div>
    </div>
</footer>
